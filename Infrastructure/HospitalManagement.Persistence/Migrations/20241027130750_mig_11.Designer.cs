...
namespace HospitalManagement.Persistence.Migrations
{
    ...
    [Migration("20241027130750_mig_11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalManagement.Domain.Entities.Identity.AppRoleAuthority", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("isCanApprove")
                        .HasColumnType("boolean");

                    b.Property<bool>("isCanDelete")
                        .HasColumnType("boolean");

                    b.Property<bool>("isCanInsert")
                        .HasColumnType("boolean");

                    b.Property<bool>("isCanSeeAll")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("HospitalManagement.Domain.Entities.Identity.AppRolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("AppRoleAuthorityId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HospitalManagement.Domain.Entities.Identity.AppUserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HospitalManagement.Domain.Entities.Management.Announcement", b =>
                {
                    ...
                    b.Property<string>("AnnouncementSummary")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("HospitalManagement.Domain.Entities.Management.DbParameter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HospitalManagement.Domain.Entities.Management.DbParameterType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HospitalManagement.Domain.Entities.Identity.AppRoleAuthority", b =>
                {
                    b.HasOne("HospitalManagement.Domain.Entities.Identity.AppRole", "AppRole")
            ...
            modelBuilder.Entity("HospitalManagement.Domain.Entities.Identity.AppRolePermission", b =>
                {
                    b.HasOne("HospitalManagement.Domain.Entities.Identity.AppRoleAuthority", "AppRoleAuthority")
                        .WithMany("RolePermissions")
                        .HasForeignKey("AppRoleAuthorityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HospitalManagement.Domain.Entities.Identity.AppRolePermission", "ParentPermission")
                        .WithMany("ChildPermissions")
                        .HasForeignKey("ParentPermissionId");

                    b.Navigation("AppRoleAuthority");
            ...
            modelBuilder.Entity("HospitalManagement.Domain.Entities.Management.DbParameter", b =>
                {
                    b.HasOne("HospitalManagement.Domain.Entities.Management.DbParameterType", "DBParameterType")
