 ...
 *   protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            AutoGenerateDbSet(modelBuilder);
        }
        ...
        private void AutoGenerateDbSet(ModelBuilder modelBuilder)
        {
            var entityTypes = Assembly.GetAssembly(typeof(HospitalManagementDbContext))
                .GetTypes()
                .Where(t => t.IsClass && !t.IsAbstract && typeof(BaseEntity).IsAssignableFrom(t));

            // Add AppUser relationships
            ...
            // Add entity types to the model builder
